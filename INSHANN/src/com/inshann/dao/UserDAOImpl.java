...
boolean status;
		...
		Query<Usermanagement> theQuery=currentSession.createQuery("from Usermanagement us where  us.emailId=:emailId",Usermanagement.class);
	...
	public Usermanagement userAuthenticate(String userName, String password) 
	{
		...
		Query<Usermanagement> theQuery=currentSession.createQuery("from Usermanagement us WHERE us.userName=:userName AND us.password=:password",Usermanagement.class);
	...
	public Integer updatePassword(String userName, String password, String confirmPassword) 
	{
		...
		Query theQuery=currentSession.createQuery("UPDATE Usermanagement  set password=:password,confirmPassword=:confirmPassword WHERE userName=:userName");
		theQuery.setParameter("userName", userName);
		theQuery.setParameter("password", password);
	...
	public ProvideService getDetailsOfAd(Integer id) 
	{
		...
		Query<ProvideService> theQuery=currentSession.createQuery("from ProvideService where id=:id",ProvideService.class);
	...
	{
		Session currentSession=sessionFactory.getCurrentSession();
		Query<PersonalInformation> theQuery=currentSession.createQuery("from PersonalInformation where userName=:userName",PersonalInformation.class);
		theQuery.setParameter("userName", userName);
		try
		{
	...
	public boolean checkForApplied(Integer adId, String userName,String checkStatus) 
	{
		boolean status;
		Session currentSession=sessionFactory.getCurrentSession();
		Query<PersonalInformation> theQuery=currentSession.createQuery("from PersonalInformation where adNumber=:adId AND userName=:userName AND "
	...
	public Usermanagement getUserDetails(String userName)
	{
		...
		Query<Usermanagement> theQuery=currentSession.createQuery("from Usermanagement where userName=:userName",Usermanagement.class);
		theQuery.setParameter("userName",userName);
	...
	public boolean checkUsernameExist(String userName)
	{
		...
		Query<Usermanagement> theQuery=currentSession.createQuery("from Usermanagement us where us.userName=:userName",Usermanagement.class);
		theQuery.setParameter("userName", userName);
	...
	public boolean checkAadharNumExist(String adharNum)
	{
		...
		Query<Usermanagement> theQuery=currentSession.createQuery("from Usermanagement us where  us.adharNum=:adharNum",Usermanagement.class);
