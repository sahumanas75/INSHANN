		...
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-4" style="margin-top: 100px">
				<div style="margin-left: 70px;">
					<p id="msg"
						style="color: red; font-size: 17px; font-family: monospace;">${msg}</p>
				</div>
				<div class="im">
					...
					<form:form action="${get}" modelAttribute="userDetails"
						...
						<div class="input-group">
							<span class="input-group-addon"><span
								...
								required="required" value="${usermanagement.userName}">
						</div>
						<div class="input-group">
							<span class="input-group-addon"><span
						...
						<div style="margin-top: 20px">
							<button type="submit" value="RESET" class="btn-block" id="button"
