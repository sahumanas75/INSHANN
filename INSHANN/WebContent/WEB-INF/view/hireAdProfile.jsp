		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				...
				<div style="margin-top: 30px">
						<table>
						<tr>
							<td><input type="text" readonly="readonly" value="${pService.need}" class="txtBox"></td>
							<td><button type="button" class="txtBox" ><span class="fa fa-inr" style="font-size:18px "> BUDGET : ${pService.price}</span></button></td>
						</tr>	
						</table>
				</div>
			</div>
			...
			<div class="col-md-6 col-md-offset-4">
				<div style="margin-top:10px">
					<div class="form-group row">
  							<label class="control-label col-md-9"><span class="glyphicon glyphicon-send"></span> Description:</label>
   							<div class="col-md-9">
    					 		<textarea  class="form-control" cols="10" rows="5" style="resize: none;background:#5A5A5A;color: white" readonly="readonly"><c:out value="${pService.description}"/></textarea>
   						 	</div>
  					</div>
				</div>
				...
				<div style="margin-top: 20px;margin-left: 110px;">
						<table>
						<tr>
							<td><input type="text" readonly="readonly" value="Duration: ${pService.duration}" class="txtBox" style="background-color:#1A84B4;font-size:18px"></td>
						</tr>	
						</table>
				</div>
				<div style="margin-top: 15px;">
						...
						<tr>
							...
							<td><input type="hidden" name="userName" value="${msg}" id="checkMsg"></td>
						</tr>	
						</table>
				</div>
					...
					<div style="margin-top: 15px;margin-left: 100px;">
						<table>
						<tr>
							<td><button  type="submit" id="button" class="btn btn-primary" style="width: 130px;background-color:#1A84B4;margin-bottom: 15px" name="action">Apply</button></td>
						</tr>	
						</table>
				</div>
			</div>
...
<script>	
    ...
    setInterval(function(){ 
    	var checkValue=document.getElementById("checkMsg").value;
    	if(checkValue!='')
    	{
    		document.getElementById("button").disabled=true;
    	}
    	
    	},500);/*here 500 means 0.5 sec*/
	}());
</script>
