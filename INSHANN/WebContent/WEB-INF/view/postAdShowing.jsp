		...
		<form:form action="${get}" method="POST" modelAttribute="applyingForm">
					<div class="col-md-6">
						<div class="Box1">
								...
								<div class="glyphicon glyphicon-briefcase" style="margin-top: 5px;">
									<table>
									<tr>
								...
								<br/>
								<div>
								<span class="fa fa-inr" style="font-size: 20px"> ${pService.price}</span>
								</div>
								<br>
								<div>
								...
								<div>
								<input type="hidden" name="id" class="aId" value="${pService.id}">
								<input type="hidden" name="userType" value="${userType}">
								</div>
								<div style="margin-top:20px;margin-bottom:15px">
									<button type="submit" value="${pService.id}" class="btn btn-primary" name="action">View</button>
								</div>
						</div> 
					</div>
					</form:form>	
