		...
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-4" style="margin-top: 10px">
				...
				<div style="margin-left: 95px">
					<p id="msg"
						style="color: red; font-size: 17px; font-family: monospace; font-weight: bold">${pmsg}</p>
				</div>
				...
				<div>
					...
					<form:form action="${get}" modelAttribute="userDetails"
						...
						<div class="input-group">
							<span class="input-group-addon"><span
								class="glyphicon glyphicon-send"></span></span> <input type="text"
								name="adharNum" id="adharNum" class="form-control"
								placeholder="AADHAR CARD NO." maxlength="12" required="required"
								onkeyup="checkAdharNum();" value="${usermanagement.adharNum}">
						</div>
						...
						<div class="input-group">
							<span class="input-group-addon"><span
								class="glyphicon glyphicon-camera"></span></span> <input type="file"
								name="scanFile" id="photo" class="form-control"
						...
						<div>
							<div class="input-group">
								<span class="input-group-addon"><span
									class="glyphicon glyphicon-info-sign"></span></span> <select
									class="form-control" name="userType" id="sel"
				...
				<div id="box">
					<div>
						<a href="#"><i class="fa  fa-facebook-square"
							style="font-size: 40px; color: #3C5A9A; margin-left: 10px; float: left; margin-top: 3px">
						</i></a>
						<div class="fix" style="">&nbsp;&nbsp;Sign Up From Facebook</div>
					</div>
					<a href="#"><i class="fa fa-google-plus-square"
						style="font-size: 40px; color: #FFFFFF; margin-left: 10px; float: left;"></i></a>
