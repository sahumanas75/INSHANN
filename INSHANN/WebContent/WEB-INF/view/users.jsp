							...
							<div class="container-fluid">	
								<div class="row">
									<div class="col-md-4 col-md-offset-4">
										<img src="<c:url value='/manageServices/profileImage'/>" class="img-circle img-responsive">
									</div>
								</div>
							</div>	
						</div>
  										...
  										<div class="form-group">
  											<label class="control-label col-md-3 text-right">Username :</label>
   												<div class="col-md-6 col-md-offset-0">
    					 							<input type="text" name="userName" class="form-control" id="" readonly="readonly" value="${usermanagement.userName}">
   						 						</div>
  										</div>
  										<div class="form-group">
  											<label class="control-label col-md-3 text-right">Password :</label>
   												<div class="col-md-6 col-md-offset-0">
    					 							<input type="text" name="password" class="form-control" id="" readonly="readonly" value="${usermanagement.password}">
   						 						</div>
  										</div>
  										<div class="form-group">
  											<label class="control-label col-md-3 text-right">Email-id :</label>
   												<div class="col-md-6 col-md-offset-0">
    					 							<input type="text" name="emailId" class="form-control" id="" readonly="readonly" value="${usermanagement.emailId}">
   						 						</div>
  										</div>
  										<div class="form-group">
  											<label class="control-label col-md-3 text-right">Aadhar No. :</label>
   												<div class="col-md-6 col-md-offset-0">
    					 							<input type="text" name="adharNum" class="form-control" readonly="readonly" value="${usermanagement.adharNum}">
   						 						</div>
  										</div>
  										<div class="form-group">
  											<label class="control-label col-md-3 text-right">About You :</label>
   												<div class="col-md-6 col-md-offset-0">
    					 							<textarea cols="29" name="aboutYou" rows="4" class="form-control" style="border-color:#1A84B4;border-radius:5px; " readonly="readonly"><c:out value="${information.aboutYou}"></c:out></textarea>
   						 						</div>
  										</div>
									</form:form>
					</div>
