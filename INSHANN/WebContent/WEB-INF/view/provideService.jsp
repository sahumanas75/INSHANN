	...
	<div class="row">
		<div class="col-md-5 col-md-offset-4">
			...
			<table>
				...
				<form:form class="form-horizontal" method="POST" action="${get}"
					modelAttribute="hireDetails">
					<div class="form-group row">
						<label class="control-label col-md-9"><span
							class="glyphicon glyphicon-send"></span> Your need:</label>
						<div class="col-md-9">
							<select class="form-control" name="need" id="sel"
								onchange="checkNeedType();">
					...
					<div class="form-group row">
						<label class="control-label col-md-9"><span
							class="glyphicon glyphicon-send"></span> For:(Maximum 255
							characters only)</label>
						<div class="col-md-9">
							<textarea class="form-control" name="forWhat" rows="2" cols="2"
								style="resize: none" required="required" maxlength="255"></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label class="control-label col-md-9"><span
							class="glyphicon glyphicon-send"></span> Price:</label>
						<div class="col-md-9">
					...
					<div class="form-group row">
						<label class="control-label col-md-9"><span
							class="glyphicon glyphicon-send"></span> Duration:</label>
						<div class="col-md-9">
					...
					<div class="form-group row">
						<label class="control-label col-md-9"><span
							class="glyphicon glyphicon-send"></span> Description:(Maximum
							1500 characters only)</label>
						<div class="col-md-9">
							<textarea class="form-control" name="description" rows="3"
								cols="3" style="resize: none" required="required"
								maxlength="1500"></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label class="control-label col-md-9"><span
							class="glyphicon glyphicon-send"></span> Location:</label>
						<div class="col-md-9">
					...
					<div style="margin-top: 20px; margin-left: 135px">
						<input type="submit" name="action" value="Submit" class="btn-info"
							id="button" required="required">
					</div>
				</form:form>
			</table>
		</div>
